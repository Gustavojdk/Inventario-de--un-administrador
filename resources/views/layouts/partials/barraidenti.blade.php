...
<div class="bg-blue px-4 py-3  text-white" style="background-color:rgb(60, 112, 255);">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div>
            <img src="{{ asset('images/Voltrix.png') }}" alt="Logo" style="height: 75px;">
        </div>
        ...
        <div>
            <span class="font-weight-bold">Proyecto:</span> Sistema de Monitoreo
        </div>

        <div>
            <span class="font-weight-bold">Módulo:</span> Identificación
        </div>
